...
export const GOV_TOKEN_ADDRESS = '0x94DBc7D227bC6d9b3Ee9243922679126515afa98'
export const GOV_TOKEN_NAME = 'DeFiconnectToken'
export const GOV_TOKEN_SYMBOL = 'DCC'
export const GOV_TOKEN_DECIMALS = 18
export const GOV_TOKEN_LOGO = 'https://dystopia-swap-seven.vercel.app/logo.svg'
export const GOV_TOKEN_ABI = abis.tokenABI

export const VE_TOKEN_ADDRESS = '0x0e06D05D08165AdeBB191fD1F4912b3BB9bC810F'
export const VE_TOKEN_NAME = 'veDYST'
export const VE_TOKEN_SYMBOL = 'veDYST'
export const VE_TOKEN_DECIMALS = 18
export const VE_TOKEN_LOGO = 'https://dystopia-swap-seven.vercel.app/logo.svg'
...
export const WFTM_ADDRESS = '0xA99cf32e9aAa700f9E881BA9BF2C57A211ae94df'
export const WFTM_NAME = 'Wrapped U2U'
...
// alternative route asset
export const USDP_ADDRESS = '0x0820957B320E901622385Cc6C4fca196b20b939F'
export const USDP_NAME = 'USD Plus'
export const USDP_SYMBOL = 'pUSDT'
export const USDP_DECIMALS = 6
export const USDP_LOGO = 'https://2173993027-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F9HhCCgYexXiRot0OWAJY%2Fuploads%2FQ41zhb0z0oV5WI1zpKEg%2FUSD%2B%20logo.png?alt=media&token=533d9ed9-6904-4f45-82a3-2c9e1060a3b5'
export const USDP_ABI = abis.erc20ABI
...
export const FACTORY_ADDRESS = '0xC705Ea192ab7affd2A93e49E28fed89aa0CEC2e0'
export const FACTORY_ABI = abis.factoryABI

export const ROUTER_ADDRESS = '0xeA5a46ABCdE7898c4d9E59682B55269Aa47C1cbA'
export const ROUTER_ABI = abis.routerABI

export const VE_DIST_ADDRESS = '0x3f355339a558427Fa7E95689A73429B8336b5b8E'
export const VE_DIST_ABI = abis.veDistABI

export const VOTER_ADDRESS = '0x07B46f74f4Ae83Da81Dbc0997Bd721a96db79DCC'
export const VOTER_ABI = abis.voterABI

export const REWARD_ADDRESS = '0x94DBc7D227bC6d9b3Ee9243922679126515afa98'
